...
import customerSupportIcon from "../assets/streamline_customer-support-1.png";
...
const quickActions = [
  { title: "Run Conflict", icon: runConflictIcon },
  { title: "Open Files", icon: folderIcon, active: true },
  { title: "Workstation", icon: workIcon, active: true },
  { title: "Quick Search", icon: searchIcon },
  { title: "Advance Search", icon: advanceSearchIcon },
];
  ...
  switch (name) {
    ...
    case "integrations":
      return (
        <svg viewBox="0 0 24 24" className={classes} aria-hidden="true">
          ...
          />
          <path
            d="M3 10.5h18M7 15.5h3M13 15.5h4"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.8"
            strokeLinecap="round"
    ...
    case "users":
      return (
        <svg viewBox="0 0 24 24" className={classes} aria-hidden="true">
          ...
          />
          <path
            d="M3.5 18.5c1.1-2.4 3-3.5 5.7-3.5s4.5 1.1 5.5 3.5M13.5 18.5c.7-1.6 2-2.5 4-2.5 1.3 0 2.3.3 3 .9"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.8"
            strokeLinecap="round"
    ...
    case "settings":
      return (
        <svg viewBox="0 0 24 24" className={classes} aria-hidden="true">
          <path
            d="M12 3.5 14 5l2.5-.3.9 2.4 2.2 1.2-.8 2.4.8 2.3-2.2 1.3-.9 2.4-2.5-.4-2 1.6-2-1.6-2.5.4-.9-2.4-2.2-1.3.8-2.3-.8-2.4 2.2-1.2.9-2.4L10 5z"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.6"
    ...
    case "cube":
      return (
        <svg viewBox="0 0 24 24" className={classes} aria-hidden="true">
          <path
            d="m12 3 7 4-7 4-7-4zM5 9l7 4 7-4M5 9v6l7 4 7-4V9"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.8"
            strokeLinejoin="round"
    ...
    case "folder":
      return (
        <svg viewBox="0 0 24 24" className={classes} aria-hidden="true">
          <path
            d="M3.5 8.5A2.5 2.5 0 0 1 6 6h4l2 2H18a2.5 2.5 0 0 1 2.5 2.5v5A2.5 2.5 0 0 1 18 18H6a2.5 2.5 0 0 1-2.5-2.5z"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.8"
            strokeLinejoin="round"
    ...
    case "briefcase":
      return (
        <svg viewBox="0 0 24 24" className={classes} aria-hidden="true">
          ...
          />
          <path
            d="M9 7V5.8A1.8 1.8 0 0 1 10.8 4h2.4A1.8 1.8 0 0 1 15 5.8V7M3.5 11.5h17"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.8"
            strokeLinecap="round"
    ...
    case "filter":
      return (
        <svg viewBox="0 0 24 24" className={classes} aria-hidden="true">
          <path
            d="M4 6.5h11M4 12h7M4 17.5h11M17 6.5h3M13 12h7M17 17.5h3"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.8"
            strokeLinecap="round"
    ...
    case "layers":
      return (
        <svg viewBox="0 0 24 24" className={classes} aria-hidden="true">
          <path
            d="m12 3 8 4.3-8 4.3L4 7.3zm0 7.5 8 4.2-8 4.3-8-4.3zm0-3.7 8 4.2"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.8"
            strokeLinejoin="round"
    ...
    case "bell":
      return (
        <svg viewBox="0 0 24 24" className={classes} aria-hidden="true">
          <path
            d="M6.5 15.5h11l-1.2-1.8V10a4.3 4.3 0 1 0-8.6 0v3.7Z"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.8"
            strokeLinejoin="round"
    ...
    case "moon":
      return (
        <svg viewBox="0 0 24 24" className={classes} aria-hidden="true">
          <path
            d="M15.5 3.5a7.6 7.6 0 1 0 5 13.3 8.2 8.2 0 1 1-5-13.3Z"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.8"
            strokeLinejoin="round"
    ...
    case "headset":
      return (
        <svg viewBox="0 0 24 24" className={classes} aria-hidden="true">
          <path
            d="M5 12a7 7 0 0 1 14 0v4.5a2 2 0 0 1-2 2h-1.5v-5H19M5 13.5h3.5v5H7a2 2 0 0 1-2-2Z"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.8"
            strokeLinecap="round"
          ...
          />
          <path
            d="M15.5 18.5a2.5 2.5 0 0 1-2.5 2.5h-2"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.8"
            strokeLinecap="round"
    ...
    case "task":
      return (
        <svg viewBox="0 0 24 24" className={classes} aria-hidden="true">
          <path
            d="m5.5 18.5 3-9.5 10 10M12.5 5.5l6 6M4 20h16"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.8"
            strokeLinecap="round"
    ...
    case "report":
      return (
        <svg viewBox="0 0 24 24" className={classes} aria-hidden="true">
          <path
            d="M6 4.5h8l4 4V19a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1v-13a1.5 1.5 0 0 1 1-1.5Z"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.8"
            strokeLinejoin="round"
          />
          <path
            d="M14 4.5V9h4M8.5 12.5l2 2 4.5-4.5"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.8"
            strokeLinecap="round"
    ...
    <section className="dashboard-panel dashboard-panel--table">
      <header className="dashboard-panel__header">
        ...
        >
          <button
            type="button"
            className="dashboard-tabs__item dashboard-tabs__item--active"
          >
            Today
          </button>
        ...
        <div className="dashboard-table__body" role="rowgroup">
          {rows.map((row, index) => (
            ...
            >
              ...
              <button
                type="button"
                className="dashboard-table__action"
        ...
        <header className="dashboard-topbar">
          ...
          <div className="dashboard-toolbar">
            <button
              ...
              aria-label="Workspace stack"
            >
              <Icon name="layers" />
            </button>
            <button
              type="button"
              className="dashboard-toolbar__icon-button dashboard-toolbar__icon-button--dot"
            ...
            <div className="dashboard-theme-toggle" aria-label="Theme">
              <button
                type="button"
                className="dashboard-theme-toggle__segment dashboard-theme-toggle__segment--active"
              ...
              <button
                type="button"
                className="dashboard-theme-toggle__segment"
            ...
            <div className="dashboard-zoom" aria-label="Zoom level">
              <button
                type="button"
                className="dashboard-zoom__button"
                aria-label="Zoom out"
              >
                -
              </button>
            ...
            <nav className="dashboard-sidebar__nav" aria-label="Primary">
              <div className="dashboard-sidebar__group">
                ...
                >
                  ...
                  <span className="dashboard-nav-item__label">Home</span>
                </button>
                <button
                  type="button"
                ...
                >
                  ...
                  <span className="dashboard-nav-item__label">Users</span>
                </button>
              </div>

              <button
                type="button"
                className="dashboard-nav-item dashboard-nav-item--settings"
                aria-label="Settings"
              >
                <span className="dashboard-nav-item__icon">
                  <img src={settingsIcon} alt="" aria-hidden="true" />
                </span>
                <span className="dashboard-nav-item__label">Settings</span>
              </button>
            </nav>
          ...
          <section className="dashboard-actions dashboard-panel">
            <div className="dashboard-actions__list">
              {quickActions.map((action) => (
                ...
                >
                  <span
                    className="dashboard-action-card__accent"
                    aria-hidden="true"
                  />
            ...
            <div className="dashboard-shortcuts">
              <button
                type="button"
                className="dashboard-shortcut dashboard-shortcut--task"
              >
              ...
              <button
                type="button"
                className="dashboard-shortcut dashboard-shortcut--report"
              >
                <span className="dashboard-shortcut__icon">
                  <Icon name="report" />
                </span>
          ...
          <aside className="dashboard-sidepanel">
            <section className="dashboard-panel dashboard-calendar">
              <header className="dashboard-calendar__header">
                <button
                  type="button"
                  className="dashboard-calendar__nav"
                  aria-label="Previous month"
                >
                  <Icon name="chevron-left" />
                </button>
                <h2 className="date-text">September, 2024</h2>
                <button
                  type="button"
                  className="dashboard-calendar__nav"
            ...
            <section className="dashboard-help">
              <img
                className="dashboard-help__background"
                src={needHelpImage}
                alt=""
                aria-hidden="true"
              />
              ...
              <div className="dashboard-help__content">
                <span className="dashboard-help__icon">
                  <img src={customerSupportIcon} alt="" aria-hidden="true" />
                </span>
                <h2>Need Help?</h2>
